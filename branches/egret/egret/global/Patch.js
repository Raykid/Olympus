...
*/
var delay = 130;
var oriDesc = Object.getOwnPropertyDescriptor(egret.TextField.prototype, "text");
var tempDesc = cloneObject(oriDesc);
tempDesc.set = function (value) {
    var _this = this;
    ...
    if (!this.__egret_TextField_text_bug_patched__ && value) {
        ...
        // 延迟刷新
        system.setTimeout(delay, function () {
