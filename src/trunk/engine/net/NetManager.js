...
define(["require", "exports", "../../core/Core", "../../core/injector/Injector", "../../core/message/CoreMessage", "../../utils/ObjectUtil", "./RequestData", "./NetMessage", "../mask/MaskManager"], function (require, exports, Core_1, Injector_1, CoreMessage_1, ObjectUtil_1, RequestData_1, NetMessage_1, MaskManager_1) {
    "use strict";
    ...
    var NetManager = /** @class */ (function () {
        function NetManager() {
            ...
            this.listenRequest(Core_1.core);
        }
        NetManager.prototype.onMsgDispatched = function (msg) {
            ...
            if (msg instanceof RequestData_1.default) {
                // 添加遮罩
                MaskManager_1.maskManager.showLoading(null, "net");
                // 指定消息参数连接上公共参数作为参数
                ObjectUtil_1.extendObject(msg.__params.data, RequestData_1.commonData);
                // 发送消息
        ...
        NetManager.prototype.listenRequest = function (observable) {
            observable.listen(CoreMessage_1.default.MESSAGE_DISPATCHED, this.onMsgDispatched, observable);
        };
        /**
         * 注册一个返回结构体
         *
        ...
        NetManager.prototype.__onResponse = function (type, result, request) {
            // 移除遮罩
            MaskManager_1.maskManager.hideLoading("net");
            // 解析结果
            var cls = this._responseDict[type];
            if (cls) {
                var response = new cls();
                // 设置配对请求和发送内核
                var observable = Core_1.core.observable;
                if (request) {
        ...
        NetManager.prototype.__onError = function (err, request) {
            ...
            MaskManager_1.maskManager.hideLoading("net");
            // 如果有配对请求，则将返回值发送到请求所在的内核里
            var observable = request ? request.__observable : Core_1.core;
            // 派发事件
    ...
    /** 再额外导出一个单例 */
    exports.netManager = Core_1.core.getInject(NetManager);
});
