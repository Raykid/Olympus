...
define(["require", "exports", "../../core/Core", "../../core/injector/Injector", "./WebPlatform"], function (require, exports, Core_1, Injector_1, WebPlatform_1) {
    "use strict";
    ...
    */
    ...
    /** 再额外导出一个单例 */
    exports.platformManager = Core_1.core.getInject(PlatformManager);
});
