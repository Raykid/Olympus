...
define(["require", "exports", "../../core/Core", "../../core/injector/Injector", "./BridgeMessage", "../panel/PanelManager", "../module/ModuleManager", "../mask/MaskManager"], function (require, exports, Core_1, Injector_1, BridgeMessage_1, PanelManager_1, ModuleManager_1, MaskManager_1) {
    "use strict";
    ...
    */
    var BridgeManager = /** @class */ (function () {
        ...
        BridgeManager.prototype.registerBridge = function () {
            ...
            if (bridges.length > 0) {
                ...
                for (var _b = 0, bridges_2 = bridges; _b < bridges_2.length; _b++) {
                    ...
                    // 派发消息
                    Core_1.core.dispatch(BridgeMessage_1.default.BRIDGE_BEFORE_INIT, bridge);
                    // 初始化Mask
            ...
            function afterInitBridge(bridge) {
                ...
                // 派发消息
                Core_1.core.dispatch(BridgeMessage_1.default.BRIDGE_AFTER_INIT, bridge);
                // 设置初始化完毕属性
        ...
        BridgeManager.prototype.testAllInit = function () {
            ...
            if (allInited)
                Core_1.core.dispatch(BridgeMessage_1.default.BRIDGE_ALL_INIT);
        };
    ...
    /** 再额外导出一个单例 */
    exports.bridgeManager = Core_1.core.getInject(BridgeManager);
});
