...
define(["require", "exports", "../../core/Core", "../../core/injector/Injector", "./NoneScenePolicy", "./SceneMessage", "../../utils/SyncUtil"], function (require, exports, Core_1, Injector_1, NoneScenePolicy_1, SceneMessage_1, SyncUtil_1) {
    "use strict";
    ...
    */
    ...
    var SceneManager = /** @class */ (function () {
        ...
        SceneManager.prototype.doChange = function (from, to, data, policy, type, begin, complete) {
            ...
            // 派发事件
            Core_1.core.dispatch(SceneMessage_1.default.SCENE_BEFORE_CHANGE, to, from);
            // 调用准备接口
            ...
            doFunc.call(policy, from, to, function () {
                ...
                // 派发事件
                Core_1.core.dispatch(SceneMessage_1.default.SCENE_AFTER_CHANGE, to, from);
                // 完成步骤
                SyncUtil_1.notify(SYNC_NAME);
            });
        };
    ...
    /** 再额外导出一个单例 */
    exports.sceneManager = Core_1.core.getInject(SceneManager);
});
