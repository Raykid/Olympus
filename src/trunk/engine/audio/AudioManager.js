...
define(["require", "exports", "../../core/injector/Injector", "../../core/Core", "./AudioTagImpl", "./AudioContextImpl"], function (require, exports, Injector_1, Core_1, AudioTagImpl_1, AudioContextImpl_1) {
    "use strict";
    ...
    */
    ...
    /** 再额外导出一个单例 */
    exports.audioManager = Core_1.core.getInject(AudioManager);
});
