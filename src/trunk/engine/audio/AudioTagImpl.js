define(["require", "exports", "../../core/Core", "./AudioMessage", "../env/Environment"], function (require, exports, Core_1, AudioMessage_1, Environment_1) {
    "use strict";
        ...
        AudioTagImpl.prototype.load = function (url) {
            ...
            if (!data) {
                ...
                node.onended = function () {
                    // 派发播放完毕事件
                    Core_1.core.dispatch(AudioMessage_1.default.AUDIO_PLAY_ENDED, url);
                };
            }
        };
        /**
...
//# sourceMappingURL=AudioTagImpl.js.map