define(["require", "exports", "../../core/Core", "../../core/observable/Observable", "../../utils/Dictionary", "./ModuleManager", "../../utils/ConstructUtil"], function (require, exports, Core_1, Observable_1, Dictionary_1, ModuleManager_1, ConstructUtil_1) {
    "use strict";
    ...
    */
    var Module = /** @class */ (function () {
        function Module() {
            ...
            this._mediators = [];
            this._disposeDict = new Dictionary_1.default();
            /*********************** 下面是模块消息系统 ***********************/
        ...
        Object.defineProperty(Module.prototype, "dependModule", {
             ...
             */
            get: function () {
                return ConstructUtil_1.getConstructor(this.constructor);
            },
            enumerable: true,
            configurable: true
        });
        ...
        Module.prototype.dispose = function () {
            if (this._disposed)
                return;
            // 关闭自身
            var cls = ConstructUtil_1.getConstructor(this.constructor);
