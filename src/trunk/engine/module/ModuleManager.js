...
define(["require", "exports", "../../core/Core", "../../core/injector/Injector", "../net/NetManager", "./ModuleMessage", "../env/Environment", "../mask/MaskManager", "../assets/AssetsManager", "../audio/AudioManager", "../version/Version"], function (require, exports, Core_1, Injector_1, NetManager_1, ModuleMessage_1, Environment_1, MaskManager_1, AssetsManager_1, AudioManager_1, Version_1) {
    "use strict";
    ...
    var ModuleManager = /** @class */ (function () {
            ...
            if (!after) {
                ...
                var loadMediatorAssets = function (err) {
                    if (err) {
                        // 隐藏Loading
                        if (!maskFlag)
                            MaskManager_1.maskManager.hideLoading("module");
                        maskFlag = false;
                        // 停止加载，调用模块加载失败接口
                        ...
                        if (cssFiles) {
                            for (var _i = 0, cssFiles_1 = cssFiles; _i < cssFiles_1.length; _i++) {
                                ...
                                cssNode.href = Environment_1.environment.toCDNHostURL(Version_1.version.wrapHashUrl(cssFile));
                        ...
                        AssetsManager_1.assetsManager.loadAssets(target.listJsFiles(), function (results) {
                            ...
                            NetManager_1.netManager.sendMultiRequests(requests, function (responses) {
                                ...
                                // 派发消息
                                Core_1.core.dispatch(ModuleMessage_1.default.MODULE_CHANGE, cls, from && from[0]);
                                // 关闭标识符
                                this._opening = false;
                                // 如果有缓存的模块需要打开则打开之
                ...
                // 显示Loading
                if (maskFlag) {
                    MaskManager_1.maskManager.showLoading(null, "module");
                    maskFlag = false;
                }
            }
        ...
        ModuleManager.prototype.close = function (clsOrName, data) {
            ...
            if (index == 0) {
                ...
                // 派发消息
                Core_1.core.dispatch(ModuleMessage_1.default.MODULE_CHANGE, to && to[0], cls);
            }
            else {
                // 数据先行
