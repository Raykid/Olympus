define(["require", "exports", "../../../trunk/engine/bridge/BridgeManager", "../../../trunk/utils/Dictionary", "../../EgretBridge"], function (require, exports, BridgeManager_1, Dictionary_1, EgretBridge_1) {
    "use strict";
    ...
    */
    var MaskEntityImpl = /** @class */ (function () {
        ...
        MaskEntityImpl.prototype.showMask = function (alpha) {
            ...
            // 显示
            var bridge = BridgeManager_1.bridgeManager.getBridge(EgretBridge_1.default.TYPE);
            // 绘制遮罩
            if (alpha == null)
...
//# sourceMappingURL=MaskEntity.js.map