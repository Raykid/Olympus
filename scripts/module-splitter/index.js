...
module.exports = function(source)
{
    ...
    while(resultCode = getModuleOpenResult(source, fromIndex))
    {
        ...
        if(resultImport)
        {
            ...
            source = `${source.substring(0, beginIndex)}(async ()=>{maskManager.showLoading(null, "__load_module__");const mod = await import(${importPath});maskManager.hideLoading("__load_module__");return moduleManager.open(mod.${moduleName}${leftParams});})()`;
            // 确保引用了maskManager
