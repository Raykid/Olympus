 ...
 */
export function compileFor(mediator:IMediator, currentTarget:ICompileTarget, target:any, envModels:any[], name:string, exp:string, mediatorCls?:IComponentConstructor, declaredMediatorCls?:IComponentConstructor, dataExp?:string):void
{
    // 将后面的编译命令缓存起来
