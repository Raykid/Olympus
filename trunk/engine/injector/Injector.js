...
export function MediatorClass(cls) {
...
/** 定义模块，支持实例注入 */
export function ModuleClass(cls) {
    ...
    listenConstruct(cls, function (instance) {
        if (instance instanceof Mediator) {
            ...
            addDelegateHandler(instance, function () {
                var observable = inModule ? instance : core;
...
var delegateHandlerDict = new Dictionary();
...
/** 在Module内托管Mediator */
export function DelegateMediator(prototype, propertyKey) {
...
function searchUIDepth(values, mediator, target, callback, addressing) {
    ...
    function handler(target, bindTargets, leftHandlers) {
        ...
        searchUI(values, target, function (target, name, exp, depth) {
            if (addressing)
                target = target[name];
            // 记录编译目标到bindTargets中
            var dict = bindTargets[depth];
        ...
        listenOnOpen(prototype, propertyKey, function (mediator) {
            ...
            if (typeof arg1 == "string") {
                ...
                if (arg3) {
                    ...
                    var nameDict = {};
                    nameDict[arg1] = "";
                    searchUI(nameDict, target, function (ui, key, value) {
                        target = ui[key];
                    });
                    evtDict[arg2] = arg3;
                }
