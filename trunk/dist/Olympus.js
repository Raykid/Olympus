...
define("core/Core", ["require", "exports", "utils/Dictionary", "core/observable/Observable"], function (require, exports, Dictionary_2, Observable_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
...
define("engine/mask/MaskManager", ["require", "exports", "core/injector/Injector", "core/Core", "engine/bridge/BridgeManager"], function (require, exports, Injector_1, Core_3, BridgeManager_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * @author Raykid
...
define("engine/net/NetManager", ["require", "exports", "core/Core", "core/injector/Injector", "core/message/CoreMessage", "utils/ObjectUtil", "engine/net/RequestData", "engine/net/NetMessage", "engine/mask/MaskManager"], function (require, exports, Core_6, Injector_4, CoreMessage_2, ObjectUtil_3, RequestData_1, NetMessage_1, MaskManager_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
...
define("engine/version/Version", ["require", "exports", "core/Core", "core/injector/Injector", "utils/URLUtil"], function (require, exports, Core_8, Injector_6, URLUtil_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * @author Raykid
...
define("engine/assets/AssetsManager", ["require", "exports", "core/injector/Injector", "core/Core", "utils/HTTPUtil", "engine/version/Version"], function (require, exports, Injector_7, Core_9, HTTPUtil_1, Version_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * @author Raykid
...
define("engine/env/Shell", ["require", "exports", "core/injector/Injector", "core/Core"], function (require, exports, Injector_8, Core_10) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * @author Raykid
...
define("engine/audio/AudioTagImpl", ["require", "exports", "core/Core", "engine/audio/AudioMessage", "engine/env/Environment"], function (require, exports, Core_11, AudioMessage_1, Environment_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * @author Raykid
...
define("engine/audio/AudioContextImpl", ["require", "exports", "engine/assets/AssetsManager", "core/Core", "engine/audio/AudioMessage", "engine/env/Environment", "engine/system/System"], function (require, exports, AssetsManager_1, Core_12, AudioMessage_2, Environment_3, System_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * @author Raykid
...
define("engine/audio/AudioManager", ["require", "exports", "core/injector/Injector", "core/Core", "engine/audio/AudioTagImpl", "engine/audio/AudioContextImpl"], function (require, exports, Injector_9, Core_13, AudioTagImpl_1, AudioContextImpl_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * @author Raykid
...
define("engine/platform/PlatformManager", ["require", "exports", "core/Core", "core/injector/Injector", "engine/platform/WebPlatform"], function (require, exports, Core_16, Injector_12, WebPlatform_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * @author Raykid
...
define("engine/model/Model", ["require", "exports", "core/Core"], function (require, exports, Core_17) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * @author Raykid
    ...
    */
    var Bind = /** @class */ (function () {
        ...
        Bind.prototype.createWatcher = function (target, exp, callback) {
            ...
            var key = ObjectUtil_6.getObjectHashs.apply(void 0, [target, exp].concat(scopes));
            var watcher = this._watcherDict[key];
            if (!watcher)
                this._watcherDict[key] = watcher = new (Watcher_1.default.bind.apply(Watcher_1.default, [void 0, this, target, exp, callback].concat(scopes)))();
            return watcher;
        };
        return Bind;
    }());
...
define("engine/bind/Watcher", ["require", "exports", "engine/bind/Utils"], function (require, exports, Utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * @author Raykid
    ...
    */
    var Watcher = /** @class */ (function () {
        function Watcher(bind, target, exp, callback) {
            ...
            this._expFunc = Utils_1.createEvalFunc(exp, 1 + scopes.length);
            // 记录回调函数
...
define("engine/bind/Mutator", ["require", "exports", "utils/ObjectUtil", "engine/bind/Dep", "engine/bind/Watcher"], function (require, exports, ObjectUtil_7, Dep_1, Watcher_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * @author Raykid
    ...
    */
    var BindManager = /** @class */ (function () {
        ...
        BindManager.prototype.bindFunc = function (mediator, ui, funcDict) {
            var _this = this;
            var bindData = this._bindDict.get(mediator);
            this.delaySearch(mediator, funcDict, ui, function (ui, key, exp) {
                if (exp) {
                    var exps;
                    ...
                    for (var i = 0, len = exps.length; i < len; i++) {
                        // 绑定表达式
                        (_a = bindData.bind).createWatcher.apply(_a, [ui, exps[i], handler.bind(_this, i), mediator.viewModel].concat(_this._envModel));
                    }
                }
                else {
                    // 无参数执行，无需绑定，一次性执行即可
         ...
         * @memberof BindManager
         */
        BindManager.prototype.bindFor = function (mediator, ui, uiDict, callback) {
            var _this = this;
            var bindData = this._bindDict.get(mediator);
            var replacer = mediator.bridge.createEmptyDisplay();
            this.delaySearch(mediator, uiDict, ui, function (ui, key, exp) {
                ...
                if (!res)
                    return;
                // 包装渲染器创建回调
                var memento = mediator.bridge.wrapBindFor(ui, function (key, value, renderer) {
                    // 设置环境变量
                    var commonScope = {
                        $key: key,
                        $value: value,
                ...
                (_a = bindData.bind).createWatcher.apply(_a, [ui, res[5], function (datas) {
                        // 赋值
         ...
         * @memberof BindManager
         */
        BindManager.prototype.bindMessage = function (mediator, ui, type, uiDict, observable) {
            var _this = this;
            if (!observable)
            ...
            var handler = function () {
                ...
                if (mediator.disposed) {
                    ...
                    _this.search(uiDict, ui, function (ui, key, exp) {
                        ...
                        ui[key] = Utils_2.evalExp.apply(void 0, [exp, mediator.viewModel, msg, mediator.viewModel].concat(_this._envModel, [commonScope]));
                    });
                }
            };
            // 添加监听
         ...
         * @memberof BindManager
         */
        BindManager.prototype.bindResponse = function (mediator, ui, type, uiDict, observable) {
            var _this = this;
            if (!observable)
                observable = Core_18.core.observable;
            var bindData = this._bindDict.get(mediator);
            var handler = function (response) {
                if (mediator.disposed) {
                    ...
                    _this.search(uiDict, ui, function (ui, key, exp) {
                        ...
                        ui[key] = Utils_2.evalExp.apply(void 0, [exp, mediator.viewModel, response, mediator.viewModel].concat(_this._envModel, [commonScope]));
                    });
                }
            };
            // 添加监听
...
define("engine/scene/SceneManager", ["require", "exports", "core/Core", "core/injector/Injector", "engine/scene/NoneScenePolicy", "engine/scene/SceneMessage", "utils/SyncUtil"], function (require, exports, Core_20, Injector_14, NoneScenePolicy_1, SceneMessage_1, SyncUtil_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * @author Raykid
...
define("engine/env/Explorer", ["require", "exports", "core/Core", "core/injector/Injector"], function (require, exports, Core_22, Injector_15) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * @author Raykid
...
define("engine/env/WindowExternal", ["require", "exports", "core/Core", "core/injector/Injector"], function (require, exports, Core_23, Injector_16) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * @author Raykid
...
define("engine/env/Hash", ["require", "exports", "core/Core", "core/injector/Injector"], function (require, exports, Core_24, Injector_17) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * @author Raykid
...
define("engine/env/Query", ["require", "exports", "core/Core", "core/injector/Injector"], function (require, exports, Core_25, Injector_18) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
     * @author Raykid
    ...
    function listenOnOpen(prototype, propertyKey, before, after) {
        ConstructUtil_3.listenConstruct(prototype.constructor, function (mediator) {
            ...
            mediator.onOpen = function () {
                ...
                var count = onOpenDict.get(target) || 0;
