...
declare module "trunk/utils/Dictionary" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/core/interfaces/IConstructor" {
    export default IConstructor;
}
declare module "trunk/core/command/Command" {
    import IMessage from "trunk/core/message/IMessage";
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/core/command/ICommandConstructor" {
    import IMessage from "trunk/core/message/IMessage";
    import Command from "trunk/core/command/Command";
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-01
...
declare module "trunk/core/observable/IObservable" {
    import IConstructor from "trunk/core/interfaces/IConstructor";
    import IMessage from "trunk/core/message/IMessage";
    import ICommandConstructor from "trunk/core/command/ICommandConstructor";
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/core/message/IMessage" {
    import IObservable from "trunk/core/observable/IObservable";
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-01
...
declare module "trunk/core/interfaces/IDisposable" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-01
...
declare module "trunk/core/message/Message" {
    import IMessage from "trunk/core/message/IMessage";
    import IObservable from "trunk/core/observable/IObservable";
    /**
     * @author Raykid
...
declare module "trunk/core/message/CommonMessage" {
    import Message from "trunk/core/message/Message";
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-01
...
declare module "trunk/core/message/CoreMessage" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/core/observable/Observable" {
    import IDisposable from "trunk/core/interfaces/IDisposable";
    import IMessage from "trunk/core/message/IMessage";
    import ICommandConstructor from "trunk/core/command/ICommandConstructor";
    import IObservable from "trunk/core/observable/IObservable";
    /**
...
declare module "trunk/utils/ConstructUtil" {
    import IConstructor from "trunk/core/interfaces/IConstructor";
    /**
     * 包装一个类型，监听类型的实例化操作
     *
...
declare module "trunk/core/injector/Injector" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/core/Core" {
    import IMessage from "trunk/core/message/IMessage";
    import ICommandConstructor from "trunk/core/command/ICommandConstructor";
    import IObservable from "trunk/core/observable/IObservable";
    /**
...
declare module "trunk/utils/CookieUtil" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/engine/bridge/IHasBridge" {
...
declare module "trunk/engine/panel/IPanelPolicy" {
...
declare module "trunk/core/interfaces/IOpenClose" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/engine/panel/IPanel" {
    import IDisposable from "trunk/core/interfaces/IDisposable";
    import IHasBridge from "trunk/engine/bridge/IHasBridge";
    import IPanelPolicy from "trunk/engine/panel/IPanelPolicy";
    import IOpenClose from "trunk/core/interfaces/IOpenClose";
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-06
...
declare module "trunk/engine/panel/IPromptPanel" {
    import IPanel from "trunk/engine/panel/IPanel";
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/engine/scene/IScene" {
    import IDisposable from "trunk/core/interfaces/IDisposable";
    import IHasBridge from "trunk/engine/bridge/IHasBridge";
...
declare module "trunk/engine/scene/IScenePolicy" {
...
declare module "trunk/engine/module/IModuleObservable" {
    import IMessage from "trunk/core/message/IMessage";
    import ICommandConstructor from "trunk/core/command/ICommandConstructor";
    import IObservable from "trunk/core/observable/IObservable";
    /**
...
declare module "trunk/engine/module/IModuleConstructor" {
    import IModule from "trunk/engine/module/IModule";
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/engine/module/IModuleDependent" {
    import IModule from "trunk/engine/module/IModule";
    import IModuleConstructor from "trunk/engine/module/IModuleConstructor";
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-10-31
...
declare module "trunk/engine/mediator/IModuleMediator" {
    import IModuleObservable from "trunk/engine/module/IModuleObservable";
    import IModuleDependent from "trunk/engine/module/IModuleDependent";
...
declare module "trunk/engine/net/IRequestPolicy" {
    import RequestData from "trunk/engine/net/RequestData";
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-11
...
declare module "trunk/engine/net/DataType" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-11
...
declare module "trunk/engine/net/ResponseData" {
    import DataType from "trunk/engine/net/DataType";
    import RequestData from "trunk/engine/net/RequestData";
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/engine/net/RequestData" {
    import IMessage from "trunk/core/message/IMessage";
    import IRequestPolicy from "trunk/engine/net/IRequestPolicy";
    import { IResponseDataConstructor } from "trunk/engine/net/ResponseData";
    import IObservable from "trunk/core/observable/IObservable";
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/engine/module/IModule" {
    import IDisposable from "trunk/core/interfaces/IDisposable";
    import IModuleMediator from "trunk/engine/mediator/IModuleMediator";
    import RequestData from "trunk/engine/net/RequestData";
    import ResponseData from "trunk/engine/net/ResponseData";
    import IModuleConstructor from "trunk/engine/module/IModuleConstructor";
    import IModuleObservable from "trunk/engine/module/IModuleObservable";
    import IModuleDependent from "trunk/engine/module/IModuleDependent";
    /**
...
declare module "trunk/engine/mediator/IMediator" {
    import IHasBridge from "trunk/engine/bridge/IHasBridge";
    import IOpenClose from "trunk/core/interfaces/IOpenClose";
    import IDisposable from "trunk/core/interfaces/IDisposable";
    /**
...
declare module "trunk/engine/mask/IMaskData" {
    import IPanel from "trunk/engine/panel/IPanel";
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/engine/mask/MaskManager" {
    import IPanel from "trunk/engine/panel/IPanel";
...
declare module "trunk/engine/bridge/IBridge" {
    import { IPromptPanelConstructor } from "trunk/engine/panel/IPromptPanel";
    import IPanelPolicy from "trunk/engine/panel/IPanelPolicy";
    import IScenePolicy from "trunk/engine/scene/IScenePolicy";
    import IMediator from "trunk/engine/mediator/IMediator";
...
declare module "trunk/engine/bridge/BridgeMessage" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-06
...
declare module "trunk/engine/panel/NonePanelPolicy" {
    import IPanel from "trunk/engine/panel/IPanel";
    import IPanelPolicy from "trunk/engine/panel/IPanelPolicy";
    /**
     * @author Raykid
...
declare module "trunk/engine/panel/PanelMessage" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-06
...
declare module "trunk/engine/system/System" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-06
...
declare module "trunk/engine/panel/PanelManager" {
    import IConstructor from "trunk/core/interfaces/IConstructor";
    import IPanel from "trunk/engine/panel/IPanel";
    import IPromptPanel, { IPromptParams, IPromptHandler, IPromptPanelConstructor } from "trunk/engine/panel/IPromptPanel";
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-06
...
declare module "trunk/engine/net/NetMessage" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-11
...
declare module "trunk/engine/net/NetUtil" {
    import DataType from "trunk/engine/net/DataType";
...
declare module "trunk/engine/net/NetManager" {
    import RequestData from "trunk/engine/net/RequestData";
    import ResponseData, { IResponseDataConstructor } from "trunk/engine/net/ResponseData";
    import IObservable from "trunk/core/observable/IObservable";
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/engine/module/ModuleMessage" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-18
...
declare module "trunk/utils/URLUtil" {
    /**
     * 规整url
     * @param url
     */
...
declare module "trunk/engine/env/Environment" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-21
...
declare module "trunk/utils/HTTPUtil" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/engine/version/Version" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-21
...
declare module "trunk/engine/assets/AssetsManager" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/engine/env/Shell" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/engine/audio/IAudio" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/engine/audio/AudioMessage" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-10-30
...
declare module "trunk/engine/audio/AudioTagImpl" {
    import IAudio, { AudioPlayParams } from "trunk/engine/audio/IAudio";
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-10-30
...
declare module "trunk/engine/audio/AudioContextImpl" {
    import IAudio, { AudioPlayParams } from "trunk/engine/audio/IAudio";
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/engine/audio/AudioManager" {
    import IAudio, { AudioPlayParams } from "trunk/engine/audio/IAudio";
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/engine/module/ModuleManager" {
    import IModule from "trunk/engine/module/IModule";
    import IModuleConstructor from "trunk/engine/module/IModuleConstructor";
    /**
     * @author Raykid
...
declare module "trunk/engine/bridge/BridgeManager" {
    import IBridge from "trunk/engine/bridge/IBridge";
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/engine/platform/IPlatform" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-21
...
declare module "trunk/engine/platform/WebPlatform" {
    import IPlatform from "trunk/engine/platform/IPlatform";
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-21
...
declare module "trunk/engine/platform/PlatformManager" {
    import IPlatform from "trunk/engine/platform/IPlatform";
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/engine/model/Model" {
    import IMessage from "trunk/core/message/IMessage";
    import IObservable from "trunk/core/observable/IObservable";
    import ICommandConstructor from "trunk/core/command/ICommandConstructor";
    /**
...
declare module "trunk/engine/bind/Utils" {
    /**
     * 创建一个执行方法，用于未来执行
     *
     * @export
     ...
     */
    export function createRunFunc(exp: string, scopeCount?: number): (...scopes: any[]) => void;
    /**
...
declare module "trunk/engine/bind/Bind" {
    import IMediator from "trunk/engine/mediator/IMediator";
    import { IWatcher, WatcherCallback } from "trunk/engine/bind/Watcher";
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/engine/bind/Watcher" {
    import Bind from "trunk/engine/bind/Bind";
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-11-06
...
declare module "trunk/engine/bind/Dep" {
    import Watcher from "trunk/engine/bind/Watcher";
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-11-06
...
declare module "trunk/engine/bind/Mutator" {
    /**
...
declare module "trunk/engine/bind/BindManager" {
    import IMediator from "trunk/engine/mediator/IMediator";
    import Bind from "trunk/engine/bind/Bind";
    import { IResponseDataConstructor } from "trunk/engine/net/ResponseData";
    import IObservable from "trunk/core/observable/IObservable";
...
declare module "trunk/engine/mediator/Mediator" {
    import IMessage from "trunk/core/message/IMessage";
    import IModuleMediator from "trunk/engine/mediator/IModuleMediator";
    import IBridge from "trunk/engine/bridge/IBridge";
    import IModule from "trunk/engine/module/IModule";
...
declare module "trunk/engine/panel/PanelMediator" {
    import Mediator from "trunk/engine/mediator/Mediator";
    import IPanel from "trunk/engine/panel/IPanel";
    import IPanelPolicy from "trunk/engine/panel/IPanelPolicy";
    /**
     * @author Raykid
...
declare module "trunk/engine/scene/NoneScenePolicy" {
    import IScene from "trunk/engine/scene/IScene";
    import IScenePolicy from "trunk/engine/scene/IScenePolicy";
    /**
     * @author Raykid
...
declare module "trunk/engine/scene/SceneMessage" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-08
...
declare module "trunk/utils/SyncUtil" {
    /**
     * 判断是否正在进行操作
     *
     * @export
...
declare module "trunk/engine/scene/SceneManager" {
    import IScene from "trunk/engine/scene/IScene";
...
declare module "trunk/engine/scene/SceneMediator" {
    import Mediator from "trunk/engine/mediator/Mediator";
    import IScene from "trunk/engine/scene/IScene";
    import IScenePolicy from "trunk/engine/scene/IScenePolicy";
    /**
...
declare module "trunk/engine/module/Module" {
    import IMessage from "trunk/core/message/IMessage";
    import ICommandConstructor from "trunk/core/command/ICommandConstructor";
    import RequestData from "trunk/engine/net/RequestData";
    import ResponseData from "trunk/engine/net/ResponseData";
...
declare module "trunk/engine/env/Explorer" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "trunk/engine/env/WindowExternal" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-05
...
declare module "trunk/engine/env/Hash" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-06
...
declare module "trunk/engine/env/Query" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-05
...
declare module "trunk/engine/net/policies/HTTPRequestPolicy" {
    import IRequestPolicy from "trunk/engine/net/IRequestPolicy";
    import RequestData from "trunk/engine/net/RequestData";
    /**
     * @author Raykid
...
declare module "trunk/engine/plugin/IPlugin" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-10-25
...
declare module "trunk/engine/injector/Injector" {
    import { IResponseDataConstructor } from "trunk/engine/net/ResponseData";
    import IModuleConstructor from "trunk/engine/module/IModuleConstructor";
    /**
     * @author Raykid
...
declare module "trunk/engine/Engine" {
    import IModuleConstructor from "trunk/engine/module/IModuleConstructor";
    import IBridge from "trunk/engine/bridge/IBridge";
    import IPlugin from "trunk/engine/plugin/IPlugin";
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-06
...
declare module "Olympus" {
    import { IInitParams } from "trunk/engine/Engine";
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-18
...
declare module "branches/dom/mask/MaskEntity" {
...
declare module "branches/dom/utils/SkinUtil" {
...
declare module "branches/dom/injector/Injector" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "DOMBridge" {
    ...
    import IMediator from "engine/mediator/IMediator";
    import { IMaskEntity } from "engine/mask/MaskManager";
    import { MaskData } from "branches/dom/mask/MaskEntity";
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-18
...
declare module "branches/egret/AssetsLoader" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-21
...
declare module "branches/egret/utils/TweenUtil" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-22
...
declare module "branches/egret/panel/BackPanelPolicy" {
    import IPanelPolicy from "engine/panel/IPanelPolicy";
    import IPanel from "engine/panel/IPanel";
    /**
     * @author Raykid
...
declare module "branches/egret/scene/FadeScenePolicy" {
    import IScenePolicy from "engine/scene/IScenePolicy";
...
declare module "branches/egret/utils/UIUtil" {
    /**
     * @author Raykid
     * @email initial_r@qq.com
...
declare module "branches/egret/mask/MaskEntity" {
    import { IMaskEntity } from "engine/mask/MaskManager";
    import IPanel from "engine/panel/IPanel";
    import IMaskData from "engine/mask/IMaskData";
    /**
...
declare module "EgretBridge" {
    ...
    import { MaskData } from "branches/egret/mask/MaskEntity";
    /**
     * @author Raykid
     * @email initial_r@qq.com
     * @create date 2017-09-18
